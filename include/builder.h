...
#ifndef ARTS_BUILDER_H
#define ARTS_BUILDER_H
...
namespace alert {
    ...
    class Builder {
    public:
        Builder(KeyType min_key, KeyType max_key, size_t max_error)
                : min_key_(min_key),
                  max_key_(max_key),
...
//                AddNotFullSegmentMessage();
        ...
        inline const std::vector<SegmentMessage<KeyType>> &get_segments_message() const{
